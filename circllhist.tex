...
Traditionally monitoring tools, either store raw data on which calculations are performed [cf. log analysis tools],
or compute latency quantiles on each host separately and store them as numeric time series [statsd].
